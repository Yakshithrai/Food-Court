...
<!DOCTYPE html>
<html lang="en">
<head><title>Ordering Food</title></head>
<body>
...
<form class="box-form" action="page1.php" method="post">
    ...
    <div class="box-inputs">
      ...
      <div class="inputs-email">
        <input id="username" name="name" class="input" placeholder="Type your Name" required>
        <label for="name" class="label-inputs">NAME:</label>
      </div>

      <div class="inputs-password">
        <input id="password"  name="tno" class="input" placeholder="Type your Table Number" required>
        <label for="password" class="label-inputs">TABLE NO:</label>
      </div>
      <div class="inputs-password">
        <input  id="number" name="pno" class="input" placeholder="Type your Phone Number" required>
        <label for="password" class="label-inputs">Phone NO:</label>
      </div>

      <div class="box-btn-login">
        <button class="btn-login"  type="submit" name="enter" value="enter">Enter</button>
      </div>
    </div>
    </form>
</div>
