...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql="INSERT INTO `department` (`d_no`,`d_name`,`item_name`) VALUES ('$name', '$pass','$item')";
...
<div class="container">
<form class="box-form" action="page2.php" method="post">
    ...
    <div class="box-inputs">
      ...
      <div class="inputs-password">
        <input name="deptname" id="password" class="input" placeholder="Type your password">
        <label for="password" class="label-inputs">dept_name</label>
      </div>
      <div class="inputs-password">
        <input name="item" id="password" class="input" placeholder="Type your password">
...
<div class="container">
<form class="box-form" action="up1.php" method="post">

    <div class="box-title">
      <h2>EDIT DEPT NAME</h2>
    </div>
    ...
    <div class="box-inputs">
      ...
      <div class="inputs-email">
        <input type="username" name="did" id="email" class="input" placeholder="Type your e-mail">
        <label for="email" class="label-inputs">dept_name</label>
      </div>
...
<div class="container">
<form class="box-form" action="del1.php" method="post">
    ...
    <div class="box-inputs">
      ...
      <div class="inputs-email">
        <input type="username" name="did" id="email" class="input" >
